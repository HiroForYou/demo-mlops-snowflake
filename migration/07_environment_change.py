...
SRC_DATA_DRIFT_BASELINE = f"{SRC_DATABASE}.{SRC_STORAGE_SCHEMA}.OBS_{MODEL_NAME}__DATA_HIST_BL"
SRC_PRED_DRIFT_BASELINE = f"{SRC_DATABASE}.{SRC_STORAGE_SCHEMA}.OBS_{MODEL_NAME}__PRED_HIST_BL"
SRC_PERF_BASELINE = f"{SRC_DATABASE}.{SRC_STORAGE_SCHEMA}.OBS_{MODEL_NAME}__PERF_BL"

# Baseline tables (target)
TGT_DATA_DRIFT_BASELINE = f"{TGT_DATABASE}.{TGT_STORAGE_SCHEMA}.OBS_{MODEL_NAME}__DATA_HIST_BL"
TGT_PRED_DRIFT_BASELINE = f"{TGT_DATABASE}.{TGT_STORAGE_SCHEMA}.OBS_{MODEL_NAME}__PRED_HIST_BL"
TGT_PERF_BASELINE = f"{TGT_DATABASE}.{TGT_STORAGE_SCHEMA}.OBS_{MODEL_NAME}__PERF_BL"
