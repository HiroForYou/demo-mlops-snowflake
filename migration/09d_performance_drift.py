...
# Tables (generic, shared across models)
PREDICTION_TABLE = "OBS_PREDICTIONS_VW"
ACTUALS_TABLE = "ACTUALS_TABLE_VW"
PERF_BASELINE = "OBS_PERFORMANCE_BL"

# Landing tables (generic, shared across models)
DATA_DRIFT_HISTOGRAMS = "OBS_DATA_HIST"
DATA_DRIFT = "OBS_DATA_DRIFT"
PRED_DRIFT_HISTOGRAMS = "OBS_PRED_HIST"
PRED_DRIFT = "OBS_PRED_DRIFT"
PERF_DRIFT = "OBS_PERFORMANCE"
...
for tbl_name, tbl_var in [
    ("OBS_DATA_HIST", DATA_DRIFT_HISTOGRAMS),
    ("OBS_DATA_DRIFT", DATA_DRIFT),
    ("OBS_PRED_HIST", PRED_DRIFT_HISTOGRAMS),
    ("OBS_PRED_DRIFT", PRED_DRIFT),
    ("OBS_PERFORMANCE", PERF_DRIFT),
]:
